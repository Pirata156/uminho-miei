...
{
    // Instance variables
    private String address;                 // Address of the sender
    private String subject;                 // Subject of the email
    private String text;                    // Text of the email
    private GregorianCalendar sendDate;     // Date the email was sent
    private GregorianCalendar receivedDate; // Date the email was received
